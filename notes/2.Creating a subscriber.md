...
>In this part I have got REALLY deep into some fundamentals and it took me around  2 full days and I would recommend not going in too deep into deep as a begineer. 
...
> Another issue, gazebo seems to be running on my iGPU rather than my dedicated gpu. fix: add this to the bottom of '.bashrc'
...
source ~/.bashrc
```
Now Gazebo and OpenGL apps should prefer NVIDIA.